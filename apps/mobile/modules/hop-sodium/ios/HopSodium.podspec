Pod::Spec.new do |s|
  ...
  s.pod_target_xcconfig = {
    'DEFINES_MODULE' => 'YES',
    'HEADER_SEARCH_PATHS' => '$(inherited) "$(PODS_TARGET_SRCROOT)/../include" "$(PODS_TARGET_SRCROOT)/../include/sodium" "$(PODS_TARGET_SRCROOT)/../cpp" "$(PODS_TARGET_SRCROOT)/../vendor/libsodium/src/libsodium/include" "$(PODS_TARGET_SRCROOT)/../vendor/libsodium/src/libsodium/include/sodium"',
